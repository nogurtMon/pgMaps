...
export function RenameTableDialog({ open, onOpenChange, connectionId, schema, table, onRenamed }: Props) {
  ...
  async function handleSave() {
    ...
    try {
      const res = await fetch("/api/pg/rename-table", {
        ...
        body: JSON.stringify({ connectionId, schema, table, newSchema, newTable }),
      });
