      ...
      <div className={`${dmMono.variable} ${dmSans.variable}`}>
        ...
        <div className="hero">
          <div className="hero-text">
            <h1 className="hero-h1">pgMaps</h1>
        ...
        <section id="features" className="section">
          <div className="section-header">
            ...
            <p className="section-sub">
              The fastest way to create, read, update, delete and share PostGIS data.
            </p>
          </div>
          ...
          <div className="features-grid">
            <div className="feature">
              ...
              <h3>Import</h3>
              <p>Load spatial files directly into PostGIS without preprocessing.</p>
            ...
            <div className="feature">
              ...
              <p>Server-side MVT tile generation streams millions of features quickly to the browser.</p>
            </div>
            <div className="feature">
        ...
        <div className="cta-section" id="deploy">
          <div className="cta-inner">
            ...
            <div className="deploy-card featured" style={{ textAlign: 'left', marginBottom: 24 }}>
              <p style={{ fontSize: 14, color: 'var(--body)', fontWeight: 300, lineHeight: 1.6, marginBottom: 0 }}>
                Bring your own PostGIS database — set <code>POSTGRES_URL</code> to get started.
              </p>
              <div className="deploy-cmd">
                <button className="copy-btn" data-copy="docker run -d -p 3000:3000 -e POSTGRES_URL=postgresql://... -v app_data:/data nogurtmon1/postgis-frontend:latest">copy</button>
                {`docker run -d \\
  -p 3000:3000 \\
  -e POSTGRES_URL=postgresql://... \\
  -v app_data:/data \\
  nogurtmon1/postgis-frontend:latest`}
              </div>
              <a href="https://github.com/nogurtMon/postgis-frontend#self-hosting" target="_blank" rel="noopener noreferrer" className="deploy-link">
                Setup guide ↗
              </a>
            </div>
          </div>
